        ...
        <PaywallGate>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
            ...
            <div className="prose max-w-none space-y-4">
              <p>
                This content is protected by the <code className="bg-gray-100 px-2 py-1 rounded">PaywallGate</code> component.
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 my-6">
                ...
                <ol className="space-y-2 text-sm">
                  <li>1. The entire page content is wrapped in <code className="bg-white px-2 py-1 rounded">PaywallGate</code></li>
